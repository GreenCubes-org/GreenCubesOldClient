...
public class RenderDragon extends RenderLiving {
	...
	protected void func_40282_a(EntityDragon entitydragon, float f, float f1, float f2) {
		...
		if(entitydragon.deathTime > 0) {
			float f5 = (((entitydragon.deathTime + f2) - 1.0F) / 20F) * 1.6F;
	...
	protected void func_40280_a(EntityDragon entitydragon, float f, float f1, float f2, float f3, float f4, float f5) {
		if(entitydragon.field_40178_aA > 0) {
			float f6 = entitydragon.field_40178_aA / 200F;
	...
	public void func_40281_a(EntityDragon entitydragon, double d, double d1, double d2, float f, float f1) {
		...
		if(entitydragon.field_41013_bH != null) {
			float f2 = entitydragon.field_41013_bH.field_41032_a + f1;
			float f3 = MathHelper.sin(f2 * 0.2F) / 2.0F + 0.5F;
			f3 = (f3 * f3 + f3) * 0.2F;
			float f4 = (float) (entitydragon.field_41013_bH.posX - entitydragon.posX - (entitydragon.prevPosX - entitydragon.posX) * (1.0F - f1));
			float f5 = (float) ((f3 + entitydragon.field_41013_bH.posY) - 1.0D - entitydragon.posY - (entitydragon.prevPosY - entitydragon.posY) * (1.0F - f1));
			float f6 = (float) (entitydragon.field_41013_bH.posZ - entitydragon.posZ - (entitydragon.prevPosZ - entitydragon.posZ) * (1.0F - f1));
			...
			float f9 = 0.0F - (entitydragon.ticksExisted + f1) * 0.01F;
			float f10 = MathHelper.sqrt_float(f4 * f4 + f5 * f5 + f6 * f6) / 32F - (entitydragon.ticksExisted + f1) * 0.01F;
			tessellator.startDrawing(5);
			int i = 8;
			for(int j = 0; j <= i; j++) {
				float f11 = MathHelper.sin(((j % i) * 3.141593F * 2.0F) / i) * 0.75F;
				float f12 = MathHelper.cos(((j % i) * 3.141593F * 2.0F) / i) * 0.75F;
				float f13 = ((j % i) * 1.0F) / i;
	...
	protected void func_40279_a(EntityDragon entitydragon, float f) {
		...
		if(entitydragon.field_40178_aA > 0) {
			RenderHelper.disableStandardItemLighting();
			float f1 = (entitydragon.field_40178_aA + f) / 200F;
			float f2 = 0.0F;
			if(f1 > 0.8F) {
				f2 = (f1 - 0.8F) / 0.2F;
			}
			...
			for(int i = 0; i < ((f1 + f1 * f1) / 2.0F) * 60F; i++) {
