...
public class RenderEnchantmentTable extends TileEntitySpecialRenderer {
	...
	public void func_40449_a(TileEntityEnchantmentTable tileentityenchantmenttable, double d, double d1, double d2, float f) {
		GL11.glPushMatrix();
		GL11.glTranslatef((float) d + 0.5F, (float) d1 + 0.75F, (float) d2 + 0.5F);
		float f1 = tileentityenchantmenttable.field_40068_a + f;
