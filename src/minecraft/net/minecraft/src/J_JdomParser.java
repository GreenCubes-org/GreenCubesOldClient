...
public final class J_JdomParser {
	...
	public J_JsonRootNode Parse(Reader reader) throws J_InvalidSyntaxException, IOException {
	...
	public J_JsonRootNode parse(String s) throws J_InvalidSyntaxException {
