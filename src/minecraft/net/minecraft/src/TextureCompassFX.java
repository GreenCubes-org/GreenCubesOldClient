...
public class TextureCompassFX extends TextureFX {
	...
	public void onTick() {
		...
		if(mc.theWorld != null && mc.thePlayer != null) {
			...
			double d2 = chunkcoordinates.posX - mc.thePlayer.posX;
			double d4 = chunkcoordinates.posZ - mc.thePlayer.posZ;
			d = ((mc.thePlayer.rotationYaw - 90F) * 3.1415926535897931D) / 180D - TrigMath.atan2(d4, d2);
