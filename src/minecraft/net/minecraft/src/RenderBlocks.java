...
public class RenderBlocks {
	...
	public boolean renderBlockFence(BlockFence blockfence, int i, int j, int k) {
		boolean flag = false;
		float f = 0.375F; // размер столбика в ширину
		float f1 = 0.625F; // размер столбика в глубину
		...
		f = 0.4375F; // нижн€€ граница нижней палочки
		f1 = 0.5625F; // верхн€€ граница нижней палочки
		float f2 = 0.75F; // верхн€€ граница верхней палочки
		float f3 = 0.9375F; // нижн€€ граница верхней палочки
		float f4 = flag3 ? 0.0F : f;
		float f5 = flag4 ? 1.0F : f1;
		float f6 = flag5 ? 0.0F : f;
		float f7 = flag6 ? 1.0F : f1;
		if(flag1) {
			blockfence.setBlockBounds(f4, f2, f, f5, f3, f1); // бокова€ верхн€€
																// палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
		if(flag2) {
			blockfence.setBlockBounds(f, f2, f6, f1, f3, f7); // обычна€ верхн€€
																// палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
		...
		f3 = 0.5625F;
		if(flag1) {
			blockfence.setBlockBounds(f4, f2, f, f5, f3, f1); // бокова€
			// нижн€€ палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
		if(flag2) {
			blockfence.setBlockBounds(f, f2, f6, f1, f3, f7); // обычна€
			// нижн€€ палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
	...
	public boolean renderBlockWhiteFence(BlockFence blockfence, int i, int j, int k) {
		...
		f = 0.4375F; // нижн€€ граница нижней палочки, дальн€€ граница
		f1 = 0.5625F; // верхн€€ граница нижней палочки
		float f2 = 0.75F; // нижн€€ граница верхней палочки
		float f3 = 0.9375F; // верхн€€ граница верхней палочки
		float f4 = flag3 ? 0.0F : f;
		float f5 = flag4 ? 1.0F : f1;
		float f6 = flag5 ? 0.0F : f;
		float f7 = flag6 ? 1.0F : f1;
		...
		f2 = 0.0625F; // нижн€€ граница по высоте нижней балки
		f3 = 0.25F; // верхн€€ граница по высоте нижней балки
		if(flag1) {
			blockfence.setBlockBounds(f4, f2, f, f5, f3, f1); // бокова€ нижн€€
																// палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
		if(flag2) {
			blockfence.setBlockBounds(f, f2, f6, f1, f3, f7); // обычна€ нижн€€
																// палка
			renderStandardBlock(blockfence, i, j, k);
			flag = true;
		}
