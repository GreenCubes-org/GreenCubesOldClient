...
abstract class ComponentNetherBridgePiece extends StructureComponent {
	...
	private StructureComponent func_40018_a(ComponentNetherBridgeStartPiece componentnetherbridgestartpiece, List list, Random random, int i, int j, int k, int l, int i1, boolean flag) {
