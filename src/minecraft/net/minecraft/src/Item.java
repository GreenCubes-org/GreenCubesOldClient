...
public class Item {
	...
	public static Item bow = new ItemBow(5, 1.0f, 1.0f).setFixItem(24 + 256).setIconCoord(5, 1).setItemName("bow");
	...
	public static Item cherryBow = new ItemCherryBow(3036 - 256, 2.0f, 2.5f).setFixItem(3038).setIconIndex(cherryBowIcon).setItemName("cherryBow");
