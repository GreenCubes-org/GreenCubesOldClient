...
public class EntityBreakingFXGC extends EntityFXGC {

	public EntityBreakingFXGC(World world, double d, double d1, double d2, Item item) {
		super(world, d, d1, d2, 0.0D, 0.0D, 0.0D);
		setTextureIndex(item.getIconFromDamage(0));
		particleRed = particleGreen = particleBlue = 1.0F;
		particleGravity = Block.blockSnow.blockParticleGravity;
		particleScale /= 2.0F;
	}

	public EntityBreakingFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5, Item item) {
