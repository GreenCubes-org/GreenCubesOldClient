...
public class ChunkProviderEnd implements IChunkProvider {
	...
	public Chunk provideChunk(int i, int j) {
		field_40396_i.setSeed(i * 0x4f9939f508L + j * 0x1ef1565bd5L);
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
		...
		int k = i * 16;
		int l = j * 16;
		BiomeGenBase biomegenbase = field_40392_m.getBiomeAt(k + 16, 127, l + 16);
	...
	public List func_40377_a(EnumCreatureType enumcreaturetype, int i, int j, int k) {
		...
		BiomeGenBase biomegenbase = field_40392_m.getBiomeAt(i, j, k);
