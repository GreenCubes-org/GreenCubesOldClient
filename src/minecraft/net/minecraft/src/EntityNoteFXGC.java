...
public class EntityNoteFXGC extends EntityFXGC {

	float noteParticleScale;

	public EntityNoteFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
		this(world, d, d1, d2, d3, d4, d5, 2.0F);
	}

	public EntityNoteFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5, float f) {
