...
public class MapItemRenderer {
	...
	public void renderMap(EntityPlayer entityplayer, RenderEngine renderengine, MapData mapdata) {
		...
		tessellator.addVertexWithUV((j + 0) + f, (k + 128) - f, -0.0099999997764825821D, 0.0D, 1.0D);
		tessellator.addVertexWithUV((j + 128) - f, (k + 128) - f, -0.0099999997764825821D, 1.0D, 1.0D);
		tessellator.addVertexWithUV((j + 128) - f, (k + 0) + f, -0.0099999997764825821D, 1.0D, 0.0D);
		tessellator.addVertexWithUV((j + 0) + f, (k + 0) + f, -0.0099999997764825821D, 0.0D, 0.0D);
		tessellator.draw();
		...
		for(Iterator iterator = mapdata.playersVisibleOnMap.iterator(); iterator.hasNext(); GL11.glPopMatrix()) {
			...
			GL11.glPushMatrix();
			GL11.glTranslatef(j + mapcoord.field_28216_b / 2.0F + 64F, k + mapcoord.field_28220_c / 2.0F + 64F, -0.02F);
			GL11.glRotatef((mapcoord.field_28219_d * 360) / 16F, 0.0F, 0.0F, 1.0F);
			GL11.glScalef(4F, 4F, 3F);
			GL11.glTranslatef(-0.125F, 0.125F, 0.0F);
			float f1 = (mapcoord.field_28217_a % 4 + 0) / 4F;
			float f2 = (mapcoord.field_28217_a / 4 + 0) / 4F;
			float f3 = (mapcoord.field_28217_a % 4 + 1) / 4F;
			float f4 = (mapcoord.field_28217_a / 4 + 1) / 4F;
			tessellator.startDrawingQuads();
