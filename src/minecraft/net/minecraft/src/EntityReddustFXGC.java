...
public class EntityReddustFXGC extends EntityFXGC {

	float reddustParticleScale;

	public EntityReddustFXGC(World world, double d, double d1, double d2, float f, float f1, float f2) {
		this(world, d, d1, d2, 1.0F, f, f1, f2);
	}

	public EntityReddustFXGC(World world, double d, double d1, double d2, float f, float f1, float f2, float f3) {
