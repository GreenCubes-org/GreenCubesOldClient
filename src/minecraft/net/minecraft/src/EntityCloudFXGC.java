...
public class EntityCloudFXGC extends EntityFXGC {

	float field_35135_a;

	public EntityCloudFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
	...
	public void onUpdate() {
		...
		EntityPlayer entityplayer = worldObj.getClosestPlayer(posX, posY, posZ, 2D);
