...
public class RecipesCrafting {
	...
	public void addRecipes(CraftingManager craftingmanager) {
		...
		craftingmanager.addRecipe(new ItemStack(Block.stoneBrick, 4), new Object[]{"##", "##", Character.valueOf('#'), Block.stone});
		craftingmanager.addRecipe(new ItemStack(Block.fenceIron, 16), new Object[]{"###", "###", Character.valueOf('#'), Item.ingotIron});
		craftingmanager.addRecipe(new ItemStack(Block.thinGlass, 16), new Object[]{"###", "###", Character.valueOf('#'), Block.glass});
	}
}
