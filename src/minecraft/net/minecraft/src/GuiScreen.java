...
public class GuiScreen extends Gui {
	...
	public void drawBackground(int i) {
		...
		tessellator.addVertexWithUV(0.0D, height, 0.0D, 0.0D, height / f + i);
		tessellator.addVertexWithUV(width, height, 0.0D, width / f, height / f + i);
		tessellator.addVertexWithUV(width, 0.0D, 0.0D, width / f, 0 + i);
