...
public class BlockFire extends Block {
	...
	protected BlockFire(int i, int j) {
		...
		chanceToEncourageFire = new int[Block.blocksLength];
		abilityToCatchFire = new int[Block.blocksLength];
		setTickOnLoad(true);
	}
	...
	public void initializeBlock() {
		...
		setBurnRate(Block.wool.blockID, 30, 60);
	...
	public void updateTick(World world, int i, int j, int k, Random random) {
		boolean flag = (world.getBlockId(i, j - 1, k) == Block.netherrack.blockID || world.getBlockId(i, j - 1, k) == Block.blockStepNetherrackUp.blockID);
