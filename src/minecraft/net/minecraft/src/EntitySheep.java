...
public class EntitySheep extends EntityAnimal {
	...
	public static final float fleeceColorTable[][] = {{1.0F, 1.0F, 1.0F}, {0.95F, 0.7F, 0.2F}, {0.9F, 0.5F, 0.85F}, {0.6F, 0.7F, 0.95F}, {0.9F, 0.9F, 0.2F}, {0.5F, 0.8F, 0.1F}, {0.95F, 0.7F, 0.8F}, {0.3F, 0.3F, 0.3F}, {0.6F, 0.6F, 0.6F}, {0.3F, 0.6F, 0.7F}, {0.7F, 0.4F, 0.9F}, {0.2F, 0.4F, 0.8F}, {0.5F, 0.4F, 0.3F}, {0.4F, 0.5F, 0.2F}, {0.8F, 0.3F, 0.3F}, {0.1F, 0.1F, 0.1F}};
	...
	protected void dropFewItems(boolean flag, int i) {
		if(!getSheared()) {
			entityDropItem(new ItemStack(Block.wool.blockID, 1, getFleeceColor()), 0.0F);
		}
	}
	...
	public boolean interact(EntityPlayer entityplayer) {
		...
		if(itemstack != null && itemstack.itemID == Item.shears.shiftedIndex && !getSheared()) {
			if(!worldObj.multiplayerWorld) {
				...
				for(int j = 0; j < i; j++) {
					EntityItem entityitem = entityDropItem(new ItemStack(Block.wool.blockID, 1, getFleeceColor()), 1.0F);
