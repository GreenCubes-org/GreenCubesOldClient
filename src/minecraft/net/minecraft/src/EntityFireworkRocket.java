...
public class EntityFireworkRocket extends Entity {
	...
	public EntityFireworkRocket(World par1World) {
		...
		this.canCollideWithEntities = false;
	}
	...
	public EntityFireworkRocket(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack) {
		...
		this.setSize(0.25F, 0.25F);
		this.setSpawnPosition(par2, par4, par6);
		this.yOffset = 0.0F;
		int var9 = 1;

		if(par8ItemStack != null && par8ItemStack.hasNBTData()) {
			this.dataWatcher.updateObject(8, par8ItemStack);
			NBTTagCompound var10 = par8ItemStack.getNBTData();
	...
	public void setVelocity(double par1, double par3, double par5) {
		...
		if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationYaw = this.rotationYaw = (float) (TrigMath.atan2(par1, par5) * 180.0D / Math.PI);
			this.prevRotationPitch = this.rotationPitch = (float) (TrigMath.atan2(par3, var7) * 180.0D / Math.PI);
		}
	}
	...
	public void onUpdate() {
		...
		this.rotationYaw = (float) (TrigMath.atan2(this.motionX, this.motionZ) * 180.0D / Math.PI);

		this.rotationPitch = (float) (TrigMath.atan2(this.motionY, var1) * 180.0D / Math.PI);
	...
	public void handleHealthUpdate(byte par1) {
		if(par1 == 17 && this.worldObj.multiplayerWorld) {
			...
			if(var2 != null && var2.hasNBTData())
				var3 = var2.nbtData.getCompoundTag("Fireworks");
			Minecraft.theMinecraft.effectRenderer.addEffect(new EntityFireworkStarterFXGC(worldObj, posX, posY, posZ, motionX, motionY, motionZ, var3));
		}
