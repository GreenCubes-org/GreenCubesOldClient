...
public class GuiTextField extends Gui {
	...
	public boolean textboxKeyTyped(char par1, int par2) {
		if(this.isEnabled && this.isFocused) {
			...
			case 3:
				GChat.copy(this.getSelectedtext());
				return true;

			case 22:
				this.writeText(GChat.paste());
				return true;
	...
	public void drawTextBox() {
		if(this.getVisible()) {
			...
			if(var4.length() > 0) {
				...
				var9 = this.fontRenderer.getStringWidth(var10) + var7 + 1;
			}
	...
	public void setSelectionPos(int par1) {
		...
		if(this.fontRenderer != null) {
			...
			if(par1 == this.field_73816_n) {
				this.field_73816_n -= this.fontRenderer.trimStringToWidth(this.text, var3).length();
			}
