...
public class EntityFootStepFXGC extends EntityFXGC {

	private int field_27018_a;
	private int field_27020_o;
	private RenderEngine currentFootSteps;

	public EntityFootStepFXGC(RenderEngine renderengine, World world, double d, double d1, double d2) {
	...
	public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5) {
		float f6 = (field_27018_a + f) / field_27020_o;
		f6 *= f6;
