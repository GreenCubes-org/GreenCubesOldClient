...
public class TileEntity {
	...
	public double getDistanceFrom(double d, double d1, double d2) {
		double d3 = (xCoord + 0.5D) - d;
		double d4 = (yCoord + 0.5D) - d1;
		double d5 = (zCoord + 0.5D) - d2;
	...
	static {
		...
		addMapping(TileEntityNormalChest.class, "NormalChest");
		addMapping(TileEntityFrame.class, "Frame");
	}
}
