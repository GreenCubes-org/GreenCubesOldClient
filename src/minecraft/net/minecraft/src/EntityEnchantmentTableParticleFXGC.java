...
public class EntityEnchantmentTableParticleFXGC extends EntityFXGC {
	...
	public EntityEnchantmentTableParticleFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
		...
		noClip = true;
		setTextureIndex((int) (Math.random() * 26D + 1.0D + 224D));
	}
