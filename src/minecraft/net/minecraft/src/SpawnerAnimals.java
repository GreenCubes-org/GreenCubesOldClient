...
public final class SpawnerAnimals {
										...
										if(var22 < 4) {
											label101: {
												...
												if(canCreatureTypeSpawnAtLocation(var34, var0, var17, var18, var19)) {
													...
													if(var0.getClosestPlayer(var23, var24, var25, 24.0D) == null) {
														float var26 = var23 - var31.posX;
														float var27 = var24 - var31.posY;
														float var28 = var25 - var31.posZ;
														...
														if(var29 >= 576.0F) {
															...
															var38.setLocationAndAngles(var23, var24, var25, var0.rand.nextFloat() * 360.0F, 0.0F);
			...
			while(j2 < i1) {
				...
				for(int k2 = 0; !flag && k2 < 4; k2++) {
					...
					if(canCreatureTypeSpawnAtLocation(EnumCreatureType.creature, world, j1, l2, k1)) {
						...
						try {
							entityliving = (EntityLiving) spawnlistentry.entityClass.getConstructor(new Class[]{net.minecraft.src.World.class}).newInstance(new Object[]{world});
	...
	static {
		nightSpawnEntities = (new Class[]{net.minecraft.src.EntitySpider.class, net.minecraft.src.EntityZombie.class, net.minecraft.src.EntitySkeleton.class});
	}
}
