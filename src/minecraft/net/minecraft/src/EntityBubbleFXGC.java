...
public class EntityBubbleFXGC extends EntityFXGC {

	public EntityBubbleFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
		...
		motionX = d3 * 0.20000000298023224D + ((float) (Math.random() * 2D - 1.0D) * 0.02F);
		motionY = d4 * 0.20000000298023224D + ((float) (Math.random() * 2D - 1.0D) * 0.02F);
		motionZ = d5 * 0.20000000298023224D + ((float) (Math.random() * 2D - 1.0D) * 0.02F);
