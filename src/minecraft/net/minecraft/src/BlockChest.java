...
public class BlockChest extends BlockContainer {
	...
	protected BlockChest(int i, String texture) {
		this(i);
	...
	public void onBlockPlacedBy(World world, int i, int j, int k, EntityLiving entityliving) {
		...
		if(texture != null || (l != blockID && i1 != blockID && j1 != blockID && k1 != blockID)) {
	...
	public void unifyAdjacentChests(World world, int i, int j, int k) {
		if(world.multiplayerWorld || texture != null) {
			return;
		}
		int l = world.getBlockId(i, j, k - 1);
		int i1 = world.getBlockId(i, j, k + 1);
	...
	public TileEntity getBlockEntity() {
		return new TileEntityChest(texture);
	}
}
