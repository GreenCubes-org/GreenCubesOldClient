...
public class RenderEnderCrystal extends Render {
	...
	public void func_41035_a(EntityEnderCrystal entityendercrystal, double d, double d1, double d2, float f, float f1) {
		if(field_41037_a != 1) {
			field_41036_b = new ModelEnderCrystal(0.0F);
			field_41037_a = 1;
		}
		float f2 = entityendercrystal.field_41032_a + f1;
		GL11.glPushMatrix();
