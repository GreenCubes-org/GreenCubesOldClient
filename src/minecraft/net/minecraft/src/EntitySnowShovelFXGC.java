...
public class EntitySnowShovelFXGC extends EntityFXGC {

	float snowDigParticleScale;

	public EntitySnowShovelFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
		this(world, d, d1, d2, d3, d4, d5, 1.0F);
	}

	public EntitySnowShovelFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5, float f) {
