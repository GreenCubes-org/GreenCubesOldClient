...
public class EntityDarknessFXGC extends EntityArmorFXGC {

	private static final int TEXTURE_CHANGE_SPEED = 15;
	private static final double SPEED_MULTIPLER = 0.8D;

	private int textures[][] = {{P_D_TEX_1_1, P_D_TEX_1_2, P_D_TEX_1_3, P_D_TEX_1_4}, {P_D_TEX_2_1, P_D_TEX_2_2, P_D_TEX_2_3, P_D_TEX_2_4}, {P_D_TEX_3_1, P_D_TEX_3_2, P_D_TEX_3_3, P_D_TEX_3_4}, {P_D_TEX_4_1, P_D_TEX_4_2, P_D_TEX_4_3, P_D_TEX_4_4}};
	private int currentTexture = 0;
	private int texturePart = 0;

	public EntityDarknessFXGC(World world, double x, double y, double z, EntityLiving source, double targetHeight) {
