...
public class EntityHugeExplodeFXGC extends EntityFXGC {

	private int field_35139_a;
	private int field_35138_ay;

	public EntityHugeExplodeFXGC(World world, double d, double d1, double d2, double d3, double d4, double d5) {
