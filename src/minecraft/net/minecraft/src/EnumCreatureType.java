...
public enum EnumCreatureType {
	monster("monster", 0, net.minecraft.src.IMob.class, 70, Material.air, false), creature("creature", 1, net.minecraft.src.EntityAnimal.class, 15, Material.air, true), waterCreature("waterCreature", 2, net.minecraft.src.EntityWaterMob.class, 5, Material.water, true);
	/*
	...
	*/
	...
	static {
		...
		*/
		allCreatureTypes = (new EnumCreatureType[]{monster, creature, waterCreature});
	}
}
