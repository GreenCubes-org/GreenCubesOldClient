...
public final class ItemStack {
	...
	/**
	 * Возвращает, есть ли у этого предмета NBT-data
	 * @return
	 */
	...
	public List<String> getDescription() {
		...
		if(q != null) {
			...
			DecorItemUnique u = getUnique();
			if(u != null)
				sb.append("\2477, \247rffff7518уникальный");
		...
		if(hasNBTData()) {
			...
			if(nbtData.hasKey("Counters")) {
				...
				for(int i = 0; i < counters.size(); ++i) {
					...
					case 1:
						arraylist.add("\2476Булыжника добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 2:
						arraylist.add("\2476Алмазов добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 3:
						arraylist.add("\2476Ростков сакуры получено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 4:
						arraylist.add("\2476Светопыли добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 5:
						arraylist.add("\2476Фейерверков запущено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 6:
						arraylist.add("\2476Листвы получено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 7:
						arraylist.add("\2476Красной пыли добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 8:
						arraylist.add("\2476Железной руды добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 9:
						arraylist.add("\2476Золотой руды добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 10:
						arraylist.add("\2476Лазурита добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 11:
						arraylist.add("\2476Дерева срублено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 12:
						arraylist.add("\2476Угля добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 13:
						arraylist.add("\2476Земли выкопано: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 14:
						arraylist.add("\2476Пройдено расстояния: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 15:
						arraylist.add("\2476Шерсти сострижено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 16:
						arraylist.add("\2476Частей блоков установлено: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 17:
						arraylist.add("\2476Известняка добыто: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 18:
						arraylist.add("\2476Тыкв собрано: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 19:
						arraylist.add("\2476Арбузов собрано: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 20:
						arraylist.add("\2476Животных убито: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					case 21:
						arraylist.add("\2476Монстров убито: " + counter.getInteger("C") + (counter.getBoolean("L") ? " \2477(заблокирован)" : ""));
						break;
					}
				}
			}
