...
public class RenderBoat extends Render {
	...
	public void renderBoat(EntityBoat entityboat, double d, double d1, double d2, float f, float f1) {
		...
		float f2 = entityboat.func_41018_h() - f1;
		float f3 = entityboat.func_41020_g() - f1;
		if(f3 < 0.0F) {
			f3 = 0.0F;
		}
		if(f2 > 0.0F) {
			GL11.glRotatef(((MathHelper.sin(f2) * f2 * f3) / 10F) * entityboat.func_41016_i(), 1.0F, 0.0F, 0.0F);
		}
