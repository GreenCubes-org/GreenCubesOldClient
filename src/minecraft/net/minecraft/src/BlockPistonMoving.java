...
public class BlockPistonMoving extends BlockContainer {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess iblockaccess, int i, int j, int k) {
		...
		if(tileentitypiston != null) {
			...
			minX = block.minX - (Facing.offsetsXForSide[l] * f);
			minY = block.minY - (Facing.offsetsYForSide[l] * f);
			minZ = block.minZ - (Facing.offsetsZForSide[l] * f);
			maxX = block.maxX - (Facing.offsetsXForSide[l] * f);
			maxY = block.maxY - (Facing.offsetsYForSide[l] * f);
			maxZ = block.maxZ - (Facing.offsetsZForSide[l] * f);
		}
	}
	...
	public AxisAlignedBB func_31035_a(World world, int i, int j, int k, int l, float f, int i1) {
		...
		if(axisalignedbb == null) {
			...
			axisalignedbb.minX -= Facing.offsetsXForSide[i1] * f;
			axisalignedbb.maxX -= Facing.offsetsXForSide[i1] * f;
			axisalignedbb.minY -= Facing.offsetsYForSide[i1] * f;
			axisalignedbb.maxY -= Facing.offsetsYForSide[i1] * f;
			axisalignedbb.minZ -= Facing.offsetsZForSide[i1] * f;
			axisalignedbb.maxZ -= Facing.offsetsZForSide[i1] * f;
