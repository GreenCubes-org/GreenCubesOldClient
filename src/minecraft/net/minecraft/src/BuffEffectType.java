...
public class BuffEffectType {
	...
	public static final BuffEffectType MOVE_SPEED_UP = new BuffEffectType(1, "MoveSpeedUp", I18n.get("\247aУскорение: %s")); // TODO translate
	public static final BuffEffectType MOVE_SPEED_DOWN = new BuffEffectType(2, "MoveSlowDown", I18n.get("\247cЗамедление: -%s")); // TODO translate
	public static final BuffEffectType DIG_SPEED_UP = new BuffEffectType(3, "DigSpeedUp", I18n.get("\247aСкорость копания: +%s")); // TODO translate
	public static final BuffEffectType DIG_SPEED_DOWN = new BuffEffectType(4, "DigSpeedDown", I18n.get("\247cСкорость копания: -%s")); // TODO translate
	...
	public static final BuffEffectType REGENERATION = new IntegerBuffEffectType(10, "Regeneration", I18n.get("\247aРегенрация: %s здоровья в сек.")); // TODO translate
	...
	public static final BuffEffectType FAST_RUN = new BuffEffectType(20, "FastRun", I18n.get("\247aСкорость бега: +%s")); // TODO translate
