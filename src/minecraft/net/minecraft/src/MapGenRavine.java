...
public class MapGenRavine extends MapGenBase {
	...
	protected void func_35626_a(long l, int i, int j, byte abyte0[], double d, double d1, double d2, float f, float f1, float f2, int k, int i1, double d3) {
			...
			for(int l2 = d8; l2 < l1; l2++) {
				...
				label0: for(int l3 = d10; l3 < j2; l3++) {
					...
					do {
						...
						if((d12 * d12 + d13 * d13) * field_35627_a[j4] + (d14 * d14) / 6D < 1.0D) {
